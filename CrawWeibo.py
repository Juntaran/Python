...
"""    
#http://blog.csdn.net/Eastmount/article/details/50720436
...
#全局变量 文件操作读写信息
inforead = codecs.open("F:\Workspace\pt\SinaWeibo_List.txt", 'r', 'utf-8')
infofile = codecs.open("F:\Workspace\pt\SinaWeibo_Info.txt", 'a', 'utf-8')
...
if __name__ == '__main__':
    ...
    #定义变量
    username = '852114622@qq.com'             #输入你的用户名
    password = 'zjc13684502706'          #输入你的密码
